...
class Qwen2TransformerBlock:
    ...
    def __call__(
        ...
        residual = self.attention(self.input_layernorm(x), offset, cache, mask)
        x += residual
...
class Qwen2ModelWeek2:
    ...
    def __call__(
        ...
        for i, transformer in enumerate(self.inner_layers):
            embeddings = transformer(embeddings, offset, cache[i], mask="causal")
